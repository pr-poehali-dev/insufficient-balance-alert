...
const locations = [
  ...
  { id: '3', name: 'ул. Гагарина, 78', available: false },
];
  ...
  return (
    <div className="max-w-5xl mx-auto">
      <Card className="border-border bg-card backdrop-blur-sm">
        <CardHeader>
          <CardTitle className="text-3xl font-heading">Онлайн-запись на шиномонтаж</CardTitle>
          <CardDescription>Выберите услугу, дату и время визита</CardDescription>
        </CardHeader>
        <CardContent>
                          ...
                          <div className="flex items-center gap-3">
                            ...
                            <div>
                              ...
                              {location.available ? (
                                ...
                                <Badge variant="outline" className="mt-1">Закрыто</Badge>
                              )}
                            </div>
                          </div>
                        </div>
          ...
          {step === 4 && (
            <div className="text-center py-12 animate-scale-in">
              ...
              <h3 className="text-2xl font-heading font-bold mb-3">Запись подтверждена!</h3>
              <p className="text-muted-foreground mb-6">
                Вы записаны на {selectedDate?.toLocaleDateString('ru-RU')} в {selectedTime}
              </p>
